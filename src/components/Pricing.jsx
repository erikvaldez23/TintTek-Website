...
const pricingConfig = {
  "vehicle-window-tinting": {
    ...
    descriptions: {
      ATC: ["Budget-friendly dyed tint", "Blocks 99% of UV rays", "Adds privacy & reduces glare"],
      CTX: ["Ceramic automotive tint", "99% UV ray block", "Reduces heat from sun"],
      IRX: ["Nano-ceramic construction", "Best heat reduction", "Superior clarity & comfort"],
    },
  },
  "tesla-window-tinting": {
    ...
    descriptions: {
      ATC: ["Entry-level Tesla tinting", "Reduces glare & improves privacy", "Blocks 99% of UV rays"],
      CTX: ["Mid-range ceramic tint", "Superior heat rejection", "99% UV ray protection"],
      IRX: ["Premium nano-ceramic tint", "Best clarity & heat reduction", "Advanced infrared blocking"],
    },
  },
  "commercial-window-tinting": {
    ...
    descriptions: {
      BASIC: ["Standard tinting for offices", "Blocks UV rays & reduces glare", "Affordable pricing"],
      PRO: ["Improved heat rejection", "Enhanced privacy & security", "Energy-efficient"],
      ULTRA: ["High-end commercial film", "Best sun protection", "Long-lasting durability"],
    },
  },
  "residential-window-tinting": {
    ...
    descriptions: {
      ...
      ULTRA: ["Premium tint with superior clarity", "Highest heat & glare reduction", "Lifetime warranty"],
    },
  },
  "vehicle-paint-correction": {
    ...
    descriptions: {
      BASIC: ["Light paint correction", "Removes minor scratches", "Enhances gloss"],
      PRO: ["Moderate paint correction", "Eliminates swirl marks", "Deep shine restoration"],
      ULTRA: ["Advanced correction", "Removes heavy imperfections", "Superior clarity & shine"],
    },
  },
  "vehicle-paint-protection": {
    ...
    descriptions: {
      BASIC: ["Basic paint protection film", "Prevents minor scratches", "1-year warranty"],
      PRO: ["Mid-tier protection film", "Better durability & shine", "3-year warranty"],
      ULTRA: ["Premium self-healing PPF", "Best scratch resistance", "5-year warranty"],
    },
  },
};
...
const PricingComponent = () => {
  ...
  return (
    <Box id="pricing" sx={{ py: 8, textAlign: "center", backgroundColor: "#111", color: "#fff" }}>
                ...
                <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.3 }}>
                  <Box sx={{ textAlign: "center", p: 3, border: "2px solid #444", borderRadius: 4, background: "rgba(255,255,255,0.1)" }}>
                    ...
                    <Typography variant="h4" sx={{ fontWeight: "bold", color: "#00FF99" }}>
                      {service.pricingData[selectedOption][tier]}
                    </Typography>
                  </Box>
                </motion.div>
              </Grid>
