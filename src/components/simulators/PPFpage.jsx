  ...
  return (
    ...
    `,
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Shield Your Vehicle’s Finish with Durable, Invisible Paint Protection Film"
            </Typography>
          </Box>
        </Container>
      </Box>
      ...
      <Box style={{ width: "100vw", height: "1000px", overflow: "hidden" }}>
        <object
          width="100%"
          data="https://llumar.com/na/en/automotive/window-film-ppf-viewer/dealer-auto-ppf-viewer/"
          height="1000px"
          style={{ border: "none" }}
