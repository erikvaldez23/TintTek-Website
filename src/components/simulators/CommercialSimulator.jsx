...
const CommercialSimulator = () => {
  useEffect(() => {
    trackEvent("simulator_view", "Simulator", "Commercial Window Tinting");
  }, []);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              COMMERCIAL WINDOW TINTING SIMULATOR
            </Typography>
            ...
            >
              Boost Office Efficiency and Privacy with Professional Window Film Solutions
            </Typography>
          </Box>
        </Container>
      </Box>
