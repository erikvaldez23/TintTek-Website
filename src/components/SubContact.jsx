              ...
              >
                <Box>
                  ...
                  <Box sx={{ display: "flex", alignItems: "flex-start", mb: 3 }}>
                    ...
                    <Box>
                      <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 0.5, color: "#fff" }}>Location</Typography>
                      <Typography variant="body2" sx={{ color: "#fff" }}>2518 West Kingsley Rd</Typography>
                      <Typography variant="body2" sx={{ color: "#fff" }}>Garland, TX</Typography>
                    </Box>
                  </Box>
                  ...
                  <Box sx={{ display: "flex", alignItems: "flex-start", mb: 3 }}>
                    ...
                    <Box>
                      <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 0.5, color: "#fff" }}>Call Us</Typography>
                      <Typography variant="body2" onClick={handlePhoneClick} sx={{ color: "#fff", "&:hover": { cursor: 'pointer', textDecoration: "underline" }}}>+1 (972) 362-8468</Typography>
                    </Box>
                  </Box>
                  ...
                  <Box sx={{ display: "flex", alignItems: "flex-start", mb: 4 }}>
                    ...
                    <Box>
                      <Typography variant="subtitle1" sx={{ fontWeight: 600, mb: 0.5, color: "#fff" }}>Email Us</Typography>
                      <Typography variant="body2" onClick={handleEmailClick} sx={{ color: "#fff", "&:hover": { cursor: 'pointer', textDecoration: "underline" } }}>info@tinttekplus.com</Typography>
                    </Box>
                  </Box>
                </Box>
